...
public class NephewRoom extends Room {
	...
	public static boolean locked = false;
		...
		public void enterRoom(Person x)
		{
			...
			x.setyLoc(this.yLoc);
			if(explored == false) {
				System.out.println("[This is the Nephew's Room]\r\n You walk into the room where you find the nephew sitting in at his desk. \r\n"
						...
						+ "   Nephew: Oh, I guess I'll introduce myself, My name's Lance Wu and I'm the nephew of this mansions owner \r\n"
			...
			System.out.println("[This is the Nephew's Room]\r\n You decide it's far too tempting to not check the contents of the letter. \r\n"
